...
def generate_plot(rC, dC, rH, kIL, kCT, s, K):
...
def home():
    ...
    if request.method == 'POST':
        ...
        # Call the generate_plot function after the request has been processed
        @after_this_request
        def call_generate_plot(response):
            generate_plot(rC, dC, rH, kIL, kCT, s, K)
            return response
